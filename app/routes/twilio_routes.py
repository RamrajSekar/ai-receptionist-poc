...
async def voice_handler(From: str = Form('4757770732'),To: str = Form('6625473791'),):
    try:
        ...
        resp = VoiceResponse()
        resp.say("Hello! You've reached the AI Receptionist. Please say your name followed by date and time for your appointment after the beep and press # key to end!")
